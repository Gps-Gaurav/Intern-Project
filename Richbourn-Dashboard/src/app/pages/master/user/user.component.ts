...
openNew() {
  this.router.navigate(['/master/CREATE_USER_MASTER']);
}
...
deleteSelectedProducts() {
  this.confirmationService.confirm({
    ...
    accept: () => {
      ...
      requestModel.table_name="TBL_USER";
...
editProduct(data: UserModel) {
  this.router.navigate(['/master/CREATE_USER_MASTER', { id: data.ID }]);
  this.item = {...data};
  this.productDialog = true;
}

deleteProduct(data: UserModel) {
  this.confirmationService.confirm({
