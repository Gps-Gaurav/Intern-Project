...
@Component({
  ...
  templateUrl: './raw_category.component.html',
  styleUrls: ['./raw_category.component.scss'],
  providers: [MessageService,ConfirmationService],
  encapsulation:ViewEncapsulation.None

})
export class RawCategoryComponent implements OnInit {
...
openNew() {
    ...
    this.router.navigate(['/master/create-raw-category']);
...
editProduct(data: CategoryModel) {
    ...
    this.router.navigate(['/master/create-raw-category', { id: data.SlNo }]);
