...
export class SubCategoryComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   private _fetchData() { 
    ...
    requestModel.SortColumn=this.sortField;
    requestModel.SortOrder=this.sortOrder;
    this.service.GetSortApiJson(requestModel).subscribe(response => {
