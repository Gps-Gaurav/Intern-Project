...
@Component({
  ...
  templateUrl: './account_sub_group.component.html',
  styleUrls: ['./account_sub_group.component.scss'],
  providers: [MessageService,ConfirmationService],
  encapsulation:ViewEncapsulation.None

})
export class AccountSubGroupComponent implements OnInit {
...
openNew() {
  this.router.navigate(['/master/CREATE_ACCOUNT_SUB_GROUP_MASTER']);
}
...
editProduct(data: ASubGroupModel) {
  this.router.navigate(['/master/CREATE_ACCOUNT_SUB_GROUP_MASTER', { id: data.SubGrpID }]);
  // this.item = {...data};
