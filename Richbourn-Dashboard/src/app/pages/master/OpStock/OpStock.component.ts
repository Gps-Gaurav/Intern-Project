...
@Component({
  ...
  templateUrl: './OpStock.component.html',
  styleUrls: ['./OpStock.component.scss'],
  providers: [MessageService,ConfirmationService]

})
export class OpSTOCKComponent implements OnInit {
...
openNew() {
  this.router.navigate(['/master/CREATE_OpSTOCK_MASTER']);
}
...
editProduct(data: OpStockModel) {
  this.router.navigate(['/master/CREATE_OpSTOCK_MASTER', { id: data.SlNo }]);
  // this.item = {...data};
