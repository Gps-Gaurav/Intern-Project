...
@Component({
  ...
  templateUrl: './Sale_Return_Detail_Invoices.component.html',
  styleUrls: ['./Sale_Return_Detail_Invoices.component.scss'],
  providers: [MessageService, ConfirmationService]

})
export class Sale_Return_Detail_InvoicesComponent implements OnInit {
