...
@Component({
  ...
  templateUrl: './insert-TBL_SALE_INVOICE_MASTER.component.html',
  styleUrls: ['./insert-TBL_SALE_INVOICE_MASTER.component.scss'],
 ...
 */
export class InsertTBL_Invoice_MASTERComponent implements OnInit, AfterViewInit, OnDestroy {
 ...
 selectEvent(item) {
  ...
  validSubmit() {
   ...
   //   request.InvNo = this.formData.get('InvNo').value;//
      ...
      postrequest.spName = "sp_ui_admin_add_SaleInvoiceMast_json";
  ...
  private _fetchData() {
    ...
    requestModel.spName = "sp_admin_GetInvoiceMast_SlNo";
