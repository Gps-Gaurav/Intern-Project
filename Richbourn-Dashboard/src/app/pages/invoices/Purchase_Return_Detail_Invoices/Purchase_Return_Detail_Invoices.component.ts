...
@Component({
  ...
  templateUrl: './Purchase_Return_Detail_Invoices.component.html',
  styleUrls: ['./Purchase_Return_Detail_Invoices.component.scss'],
  providers: [MessageService, ConfirmationService]

})
export class Purchase_Return_Detail_InvoicesComponent implements OnInit {
