...
cm: any;
  ...
  ngOnInit(): void {
   ...
   viewProduct(product: InvoiceModel) {
...
openNew() {
  this.router.navigate(['/invoices/insert-TBL_SALE_INVOICE_MASTER']);
}
...
deleteSelectedProducts() {
  this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        requestModel.table_name="FgSaleHead";
...
editProduct(data: InvoiceModel) {
  this.router.navigate(['/invoices/insert-TBL_SALE_INVOICE_MASTER', { id: data.SlNo }]);
