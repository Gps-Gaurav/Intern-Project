...
@Component({
  ...
  templateUrl: './insert-TBL_PURCHASE_RETURN.component.html',
  styleUrls: ['./insert-TBL_PURCHASE_RETURN.component.scss'],
 ...
 */
export class InsertTBL_PURCHASE_RETURNComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  PurchaseData: Purchase_ReturnModel[] = [];
  ...
  validSubmit() {
    ...
    if (this.formData.valid) {
      let request: Purchase_ReturnModel = <Purchase_ReturnModel>{};
    ...
    request.LocationID = this.formData.get('LocationID').value;//
      ...
      let jsonData: Purchase_ReturnModel[] = [];
