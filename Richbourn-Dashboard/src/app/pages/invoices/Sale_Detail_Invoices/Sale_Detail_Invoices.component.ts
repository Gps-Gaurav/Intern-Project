...
@Component({
  ...
  templateUrl: './Sale_Detail_Invoices.component.html',
  styleUrls: ['./Sale_Detail_Invoices.component.scss'],
  providers: [MessageService, ConfirmationService]

})
export class Sale_Detail_InvoicesComponent implements OnInit {
  breadCrumbItems: Array<{}>;
  productDialog: boolean;
  id: Number = 0;
  items: PurchaseDetailModel[];
  PurchaseData: InvoiceModel[] = [];
  prodData: InvoiceModel[] = [];
  page: number = 1;
  pageSize: number = 10;
  item: InvoiceModel = <InvoiceModel>{};
  purchaseData: InvoiceModel = <InvoiceModel>{};
  search: string = "";
