...
@Component({
  ...
  templateUrl: './dialog-insert-purchase.component.html',
  styleUrls: ['./dialog-insert-purchase.component.scss'],
 ...
 */
export class DialogInsertPURCHASEComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.formData = this.formBuilder.group({
     ...
     this.PurchaseData=this.config.data.item;
    // this.LocationData=this.config.data.location;
     console.log("this.PurchaseData",this.PurchaseData)
   if (this.PurchaseData != null && this.PurchaseData.length) {
    this.PurchaseData.forEach(obj => {
