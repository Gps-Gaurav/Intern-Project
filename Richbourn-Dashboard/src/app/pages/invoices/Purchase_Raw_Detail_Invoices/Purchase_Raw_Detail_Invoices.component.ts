...
@Component({
  ...
  templateUrl: './Purchase_Raw_Detail_Invoices.component.html',
  styleUrls: ['./Purchase_Raw_Detail_Invoices.component.scss'],
  providers: [MessageService, ConfirmationService]

})
export class Purchase_Raw_Detail_InvoicesComponent implements OnInit {
