...
@Component({
  ...
  templateUrl: './sale-finished-goods.component.html',
  styleUrls: ['./sale-finished-goods.component.scss'],
  providers: [MessageService,ConfirmationService]

})
export class SaleFinishedGoodsComponent implements OnInit {
...
public readonly ImgUrl = environment.APIUrl;
  ...
  ngOnInit(): void {
   ...
   private _fetchData() { 
    ...
    requestModel.spName="sp_admin_Get_SaleFinished_Mast";
...
openNew() {
  this.router.navigate(['/invoices/insert-Sale-finished-goods']);
}
...
deleteSelectedProducts() {
  this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        requestModel.table_name="SaleHead";
...
editProduct(data: InseretFinishesGoodsModel) {
  this.router.navigate(['/invoices/insert-Sale-finished-goods',{ id: data.SlNo }]);
