...
@Component({
  ...
  templateUrl: './Purchase-finished-goods.component.html',
  styleUrls: ['./Purchase-finished-goods.component.scss'],
  providers: [MessageService,ConfirmationService]

})
export class PurchaseFinishedGoodsComponent implements OnInit {
  breadCrumbItems: Array<{}>;
  productDialog: boolean;
  Delete:"Delete";
  items: PurchaseFinishesGoodsModel[];
  page:number=1;
  pageSize:number=10;
  item: PurchaseFinishesGoodsModel=<PurchaseFinishesGoodsModel>{};
  search: string = "";
  totalRecords:number=0;
  selectedItems: PurchaseFinishesGoodsModel[];
  submitted: boolean;
...
public readonly ImgUrl = environment.APIUrl;
  ...
  ngOnInit(): void {
   ...
   private _fetchData() { 
    ...
    requestModel.spName="sp_admin_Get_PurchaseFinished_Mast";
...
openNew() {
  this.router.navigate(['/invoices/insert-Purchase-finished-goods']);
}
...
deleteSelectedProducts() {
  this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        requestModel.table_name="PurFgHead";
...
editProduct(data: PurchaseFinishesGoodsModel) {
  this.router.navigate(['/invoices/insert-Purchase-finished-goods',{ id: data.SlNo }]);
 
}

deleteProduct(data: PurchaseFinishesGoodsModel) {
  this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        this.item =<PurchaseFinishesGoodsModel>{};
