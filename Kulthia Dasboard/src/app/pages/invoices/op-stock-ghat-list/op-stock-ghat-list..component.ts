...
@Component({
  selector: 'app-op-stock-ghat-list',
  templateUrl: './op-stock-ghat-list.component.html',
  styleUrls: ['./op-stock-ghat-list.component.scss'],
  providers: [MessageService,ConfirmationService]

})
export class GhatStockListComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   private _fetchData() { 
    ...
    requestModel.spName="sp_admin_Get_op-stock-ghat";
...
openNew() {
  this.router.navigate(['/invoices/op-stock-ghat']);
}
...
deleteSelectedProducts() {
  this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        requestModel.table_name="GhatOpStkHead";
...
editProduct(data: PriceListModel) {
  this.router.navigate(['/invoices/op-stock-ghat', { id: data.SlNo }]);
  // this.item = {...data};
