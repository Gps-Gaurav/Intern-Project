...
deleteSelectedProducts() {
  this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        requestModel.column_name="WPCID";
        requestModel.column_value=this.selectedItems.map(a=>a.WPCID).toString();
...
editProduct(data: DiamondModel) {
  this.router.navigate(['/master/CREATE_DIAMOND_MASTER', { id: data.WPCID }]);
  // this.item = {...data};
...
deleteProduct(data: DiamondModel) {
  this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        requestModel.table_name="DiamondMast";
        requestModel.column_name="WPCID";
        requestModel.column_value=data.WPCID.toString();
