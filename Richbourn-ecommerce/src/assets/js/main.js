        ...
        if (target.length > 0) {
            target.each(function () {
                var el = $(this),
                    ...
                    dataNavLeft = (el.data('owl-nav-left')) ? el.data('owl-nav-left') : "<img src='/assets/img/icon/arrow-left.svg' />",
                    dataNavRight = (el.data('owl-nav-right')) ? el.data('owl-nav-right') : "<img src='/assets/img/icon/arrow-right.svg' />",
